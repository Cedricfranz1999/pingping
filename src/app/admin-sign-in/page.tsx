  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundSize: "110%", // zoomed-out effect but still full screen
      }}
    >
      {/* Background overlay */}
            ...
            >
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center">
                  <input
                    type="checkbox"
                    className="h-4 w-4 rounded border-gray-300 text-[#f8610e] focus:ring-[#f8610e]"
                  />
                ...
                <a
                  href="#"
                  className="text-sm font-medium text-[#f8610e] hover:text-[#f8610e]/80"
                >
                  Forgot password?
                </a>
              </div>
